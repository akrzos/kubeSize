...
func DisplayClusterData(clusterCapacityData ClusterCapacityData, displayReadable bool) {
...
func DisplayNodeRoleData(nodeRoleCapacityData map[string]*ClusterCapacityData, sortedRoleNames []string, displayReadable bool) {
	w := new(tabwriter.Writer)
	w.Init(os.Stdout, 0, 5, 1, ' ', 0)
	if displayReadable == true {
...
func DisplayNodeData(nodesCapacityData map[string]*NodeCapacityData, sortedNodeNames []string, displayReadable bool) {
	w := new(tabwriter.Writer)
	w.Init(os.Stdout, 0, 5, 1, ' ', 0)
	if displayReadable == true {
...
func DisplayNamespaceData(namespaceCapacityData map[string]*NamespaceCapacityData, sortedNamespaceNames []string, displayReadable bool) {
	w := new(tabwriter.Writer)
	w.Init(os.Stdout, 0, 5, 1, ' ', 0)
	if displayReadable == true {
